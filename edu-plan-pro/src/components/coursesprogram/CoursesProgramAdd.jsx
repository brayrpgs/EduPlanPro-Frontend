...
const CoursesProgramAdd = ({ loadData, textToAdd, studyPlans, formatDate }) => {
  ...
  const handleAdd = async () => {
    ...
    const payload = JSON.stringify(coursesProgramData);

    // Verificar el tamaño del cuerpo
    console.log("Tamaño del payload:", payload.length / (1024 * 1024), "MB");
